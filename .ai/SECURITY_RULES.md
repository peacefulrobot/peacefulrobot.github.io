# SECURITY FIRST - MANDATORY FOR ALL AI AGENTS

## 🔒 CRITICAL: READ THIS FIRST

**Privacy, safety, and security are ALWAYS prioritized in EVERY action.**

This rule applies to ALL AI agents (ChatGPT, Claude, Copilot, Gemini, Amazon Q, Cursor, Aider, etc.) working on this project, in every session, without exception.
...
- This rule is **MANDATORY** for all AI agents (regardless of platform)
- Applies to: ChatGPT, Claude, Copilot, Gemini, Amazon Q, Cursor, Aider, and any other AI
